...
(function(){
  ...
  const DEFS = [
    ...
    { id:'mosshorn', name:'Mosshorn', faction:'living', biome:'Verdant', temp:'Passive', threat:'None',
      build:buildMosshorn, on:[1,12,13,15], scale:0.62, fly:false, glow:false, shy:false, spawn:true, scanOn:1, hp:8,
    ...
    { id:'frostmane', name:'Frostmane', faction:'living', biome:'Frostpeak', temp:'Neutral', threat:'Low',
      build:buildFrostmane, on:[20,8], scale:0.68, fly:false, glow:false, shy:false, spawn:true, scanOn:20, hp:12,
    ...
    { id:'driftjelly', name:'Driftjelly', faction:'living', biome:'Aquaria', temp:'Passive', threat:'None',
      build:buildDriftjelly, on:[1,4,12,13,20], scale:0.6, fly:true, glow:true, shy:false, spawn:true, scanOn:40, flyLow:true, hp:5,
    ...
    { id:'sporeling', name:'Sporeling', faction:'living', biome:'Mycelia', temp:'Neutral', threat:'Low',
      build:buildSporeling, on:[36,12,13], scale:0.7, fly:false, glow:false, shy:false, spawn:true, scanOn:36, hp:5,
    ...
    { id:'skate', name:'Skate', faction:'living', biome:'Aquaria', temp:'Passive', threat:'None',
      build:buildSkate, on:[1,4,12,13,20,36], scale:0.7, fly:true, glow:false, shy:false, spawn:true, scanOn:1, hp:5,
    ...
    { id:'glowmoth', name:'Glowmoth', faction:'living', biome:'Mycelia', temp:'Passive', threat:'None',
      build:buildGlowmoth, on:[1,12,13,36], scale:0.7, fly:true, glow:true, shy:false, spawn:true, scanOn:36, flyLow:true, hp:4,
    ...
    { id:'cinderhound', name:'Cinderhound', faction:'living', biome:'Ember', temp:'Hostile', threat:'High',
      ...
      hp:16, dmg:14, aggro:18, atkRange:2.4, atkCd:1.3, speed:3.4, prowl:true, faceYaw:-Math.PI/2,
